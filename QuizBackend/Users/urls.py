...
from Users.views import CreateTeacher,CreateStudent,getTeachers,CreateQuiz,getQuizById,CreateQuestion,GetQuizAndQuestionsbyID,CreateAnswer,GetAnswers,GetCorrectAnswersByQuestion,GetEntireQuiz,SubmitQuiz,getResposesForQuizT,RegisterTeacher,checkUser,Login,Logout,enroll,GetEnrolledTeeachers,GetQuizByQuizId
...
urlpatterns = [
    ...
    path("GetCorrectAnswers/<int:pk>",GetCorrectAnswersByQuestion.as_view()),
     ...
     path("auth/Quiz/<int:id>",GetQuizByQuizId.as_view())
]
